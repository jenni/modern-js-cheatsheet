# Modern JavaScript Cheatsheet en Español
Texto original:
...
* [Conceptos Básicos](#conceptos-básicos)
  ...
  + [Destructurar objetos y Arrays](#desestructurar-objetos-y-arrays)
    - [Explicación con código de ejemplo](#explain-with-sample-code)
    - [Recursos útiles](#useful-resources-1)
  + [Métodos de Array - map, filter, reduce](#array-methods)
  ...
  + [Abreviación para propiedad de objeto](#abreviacion-propiedad-objeto)
  ...
  + [Promesas](#promesas)
    ...
    - [Explicación](#explicación-3)
      ...
      * [Uso del ejecutor de Promesas](#ejecutor-de-promesas)
    - [Recursos externos](#recursos-externos)
